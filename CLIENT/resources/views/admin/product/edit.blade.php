        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('product_edit',$result_product_decode[0]->masanpham)}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtUserName" class="bmd-label-floating">Tên sản phẩm</label>
                                        <input value="{{$result_product_decode[0]->tensanpham}}" type="text" class="form-control" id="txtName" name="txtName">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$result_product_decode[0]->dacta}}" type="text" class="form-control" id="txtDescription" name="txtDescription">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$result_product_decode[0]->hinhdaidien}}" type="text" class="form-control" id="txtLinkAvatar" name="txtLinkAvatar">
                                    </div>
                                </div>
                            </div>
                            <br>
